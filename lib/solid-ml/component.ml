...
module Ssr_env : COMPONENT_ENV = struct
  ...
  module Html = struct
    ...
    let div ?id:_ ?class_:_ ?style:_ ?role:_ ?aria_label:_ ?aria_hidden:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let span ?id:_ ?class_:_ ?style:_ ?role:_ ?aria_label:_ ?aria_hidden:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let p ?id:_ ?class_:_ ?role:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let pre ?id:_ ?class_:_ ~children:_ () = ()
    let code ?id:_ ?class_:_ ~children:_ () = ()
    let h1 ?id:_ ?class_:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let h2 ?id:_ ?class_:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let h3 ?id:_ ?class_:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let h4 ?id:_ ?class_:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let h5 ?id:_ ?class_:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let h6 ?id:_ ?class_:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let header ?id:_ ?class_:_ ?role:_ ?data:_ ~children:_ () = ()
    let footer ?id:_ ?class_:_ ?role:_ ?data:_ ~children:_ () = ()
    let main ?id:_ ?class_:_ ?role:_ ?data:_ ~children:_ () = ()
    let nav ?id:_ ?class_:_ ?role:_ ?aria_label:_ ?data:_ ~children:_ () = ()
    let section ?id:_ ?class_:_ ?role:_ ?aria_label:_ ?aria_labelledby:_ ?data:_ ~children:_ () = ()
    let article ?id:_ ?class_:_ ?role:_ ?data:_ ~children:_ () = ()
    let aside ?id:_ ?class_:_ ?role:_ ?aria_label:_ ?data:_ ~children:_ () = ()
    let a ?id:_ ?class_:_ ?href:_ ?target:_ ?rel:_ ?download:_ ?hreflang:_ ?tabindex:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let strong ?id:_ ?class_:_ ~children:_ () = ()
    let em ?id:_ ?class_:_ ~children:_ () = ()
    let br () = ()
    let hr ?class_:_ () = ()
    let ul ?id:_ ?class_:_ ?role:_ ?data:_ ~children:_ () = ()
    let ol ?id:_ ?class_:_ ?start:_ ?role:_ ?data:_ ~children:_ () = ()
    let li ?id:_ ?class_:_ ?role:_ ?onclick:_ ?data:_ ~children:_ () = ()
    ...
    let input ?id:_ ?class_:_ ?type_:_ ?name:_ ?value:_ ?placeholder:_ ?accept:_ ?min:_ ?max:_ ?step:_
        ?required:_ ?disabled:_ ?checked:_ ?autofocus:_ ?readonly:_ ?tabindex:_ ?oninput:_ ?onchange:_ ?onkeydown:_ ?data:_ () = ()
    let textarea ?id:_ ?class_:_ ?name:_ ?placeholder:_ ?rows:_ ?cols:_
        ?required:_ ?disabled:_ ?autofocus:_ ?readonly:_ ?tabindex:_ ?oninput:_ ?data:_ ~children:_ () = ()
    let select ?id:_ ?class_:_ ?name:_ ?required:_ ?disabled:_ ?multiple:_ ?autofocus:_ ?tabindex:_
        ?onchange:_ ?data:_ ~children:_ () = ()
    let option ?value:_ ?selected:_ ?disabled:_ ~children:_ () = ()
    let label ?id:_ ?class_:_ ?for_:_ ~children:_ () = ()
    let button ?id:_ ?class_:_ ?type_:_ ?disabled:_ ?tabindex:_ ?aria_label:_ ?aria_expanded:_ ?aria_controls:_ ?aria_haspopup:_ ?onclick:_ ?data:_ ~children:_ () = ()
    let img ?id:_ ?class_:_ ?src:_ ?alt:_ ?width:_ ?height:_ ?loading:_ ?srcset:_ ?sizes:_ ?data:_ () = ()
  end
end
